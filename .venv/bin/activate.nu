...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/tk-tanab/taketo/syuron/git/debiantospdx/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('debiantospdx-py3.10' == '') {
...
alias deactivate = source '/home/tk-tanab/taketo/syuron/git/debiantospdx/.venv/bin/deactivate.nu'
